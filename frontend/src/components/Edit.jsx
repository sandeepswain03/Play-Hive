...
function Edit({ intialContent, onCancel, onSave }) {
  const [editedContent, setEditedContent] = useState(intialContent);
  ...
  return (
    <div className="w-full text-sm">
      ...
      <div className="space-x-4 mt-3 w-3/4 inline-flex justify-end items-center">
        ...
        <button
          onClick={handleSave}
          className="bg-[#222222] py-1 px-3 font-normal rounded-lg
